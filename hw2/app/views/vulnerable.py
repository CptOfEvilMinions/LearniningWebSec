...
# Add blueprints
vulnerable = Blueprint('vulnerable', __name__, url_prefix="/vulnerable", template_folder='templates')

@vulnerable.route('/transfer_money', methods=['GET', 'POST'])
@login_required
@csrf.exempt
def vulnerable_transfer_money():
    """
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('vulnerable.vulnerable_transfer_money'))
